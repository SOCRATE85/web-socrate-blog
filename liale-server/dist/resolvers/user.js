...
const LoginInput_1 = require("../utils/LoginInput");
...
let UserResolver = class UserResolver {
    ...
    forgetPassword({ redis }, email) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield redis.set(constant_1.FORGET_PASSWORD_PREFIX + token, user.id, 'ex', 5000);
            return true;
        });
    }
    me(ctx) {
    ...
    register(options, ctx) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const response = (0, validateUser_1.validateUser)(options);
                if (response) {
                    return response;
                }
                const user = yield User_1.User.findOne({ email: options.email });
                if (user) {
                    return {
                        errors: [
                            {
                ...
                const hasPassword = yield argon2_1.default.hash(options.password);
...
__decorate([
    (0, type_graphql_1.Mutation)(() => UserResponse),
    __param(0, (0, type_graphql_1.Arg)("options", () => UserInput_1.UserInput)),
...
__decorate([
    (0, type_graphql_1.Mutation)(() => UserResponse),
    __param(0, (0, type_graphql_1.Arg)("options", () => LoginInput_1.LoginInput)),
    __param(1, (0, type_graphql_1.Ctx)()),
    __metadata("design:type", Function),
